      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="space-y-12 text-gray-300">
          ...
          <section>
            ...
            <h3 className="text-xl font-medium text-white mb-3">3.3 Sistema de Memoria Persistente</h3>
            <div className="space-y-4 mb-6">
              <p>
                Fromelabs incorpora un sistema de memoria que extrae y almacena autom&aacute;ticamente informaci&oacute;n relevante de sus
                conversaciones (como su nombre, ocupaci&oacute;n, preferencias, ubicaci&oacute;n u otros datos que usted comparta durante el
                uso del Servicio) con el fin de personalizar futuras interacciones y ofrecer respuestas m&aacute;s contextualizadas.
              </p>
              <p>Estos datos de memoria:</p>
              <ul className="space-y-1 ml-6 border-l-2 border-gray-800 pl-6">
                <li>Se almacenan de forma asociada a su cuenta de usuario en nuestra base de datos</li>
                <li>Se conservan entre sesiones para mantener la continuidad de la experiencia</li>
                <li>Incluyen un nivel de confianza asociado a cada dato almacenado</li>
                <li>Se inyectan como contexto en las solicitudes a los modelos de IA para personalizar las respuestas</li>
              </ul>
              <p>
                <span className="text-white font-medium">Derechos del usuario sobre la memoria:</span> Usted puede consultar, modificar
                o eliminar en cualquier momento los datos almacenados en el sistema de memoria desde la configuraci&oacute;n de su cuenta.
                Tambi&eacute;n puede desactivar completamente la funcionalidad de memoria persistente, en cuyo caso Fromelabs no
                retendr&aacute; informaci&oacute;n entre sesiones.
              </p>
              <p className="text-sm text-gray-400 italic">
                Base jur&iacute;dica: Consentimiento (art. 6.1.a RGPD). Al utilizar Fromelabs por primera vez, se le informar&aacute; de esta
                funcionalidad y podr&aacute; aceptarla o rechazarla. La desactivaci&oacute;n de la memoria no afectar&aacute; al funcionamiento
                b&aacute;sico del Servicio.
              </p>
            </div>

            <h3 className="text-xl font-medium text-white mb-3">3.4 Datos de Pago y Facturación</h3>
            <div className="space-y-4 mb-6">
            ...
            <h3 className="text-xl font-medium text-white mb-3">3.5 Datos Técnicos y de Navegación</h3>
            ...
            <h3 className="text-xl font-medium text-white mb-3">3.6 Datos de Comunicación</h3>
